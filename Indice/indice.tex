...
&\\
{\color{bluesol}\fontsize{50}{50}\selectfont Vol. I, No. 1}&\\
&\\
\rowcolor{csccccccc}
Nada é impossível:  José Manuel Alberto  & {\fontsize{50}{50}\selectfont 1}\\
\rowcolor{cscccccc}
Solução em ação: Javier Benede &  {\fontsize{50}{50}\selectfont 2}\\
\rowcolor{csccccc}
Matemática em engenharia: a catenária & {\fontsize{50}{50}\selectfont 3}\\
\rowcolor{cscccc}
Informática en ingeniería: introducción a Octave & {\fontsize{50}{50}\selectfont 11}\\
\rowcolor{csccc}
Novedades: Boavista II, floating power plant &{\fontsize{50}{50}\selectfont 14}\\
\rowcolor{cscc}
Pensar jugando&  {\fontsize{50}{50}\selectfont 16}\\
\end{tabularx}}}
\end{document}
%%% Local Variables: 
%%% mode: latex
